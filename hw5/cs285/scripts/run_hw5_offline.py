...
def run_training_loop(config: dict, logger: Logger, args: argparse.Namespace):
    ...
    for step in tqdm.trange(1, config["training_steps"]+1, dynamic_ncols=True):
...
def main():
    ...
    parser.add_argument("--log_suffix", type=str, default="", help="append suffix to log_name")
    ...
    if args.log_suffix: 
        config["log_name"] += f"_{args.log_suffix}"
