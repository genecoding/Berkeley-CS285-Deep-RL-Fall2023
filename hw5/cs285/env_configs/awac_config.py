...
from cs285.infrastructure.utils import traverse_dict
...
def awac_config(
    ...
    **kwargs,
    ...
    # show hyperparameters, except for functions
    print('awac_config', {k: v for k, v in traverse_dict(locals()) if not callable(v)}, sep='')
