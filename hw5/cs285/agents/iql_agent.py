...
class IQLAgent(AWACAgent):
    ...
    def compute_advantage(
        ...
        # use target_critic according to the paper,
        # although I think use critic here should be ok too?
    ...
    def update_q(
        ...
        with torch.no_grad():
            next_values = self.value_critic(next_observations).squeeze(1)
    ...
    def iql_expectile_loss(
        ...
        mu = target_qs - vs
        return torch.where(mu > 0, expectile * mu**2, (1 - expectile) * mu**2)
