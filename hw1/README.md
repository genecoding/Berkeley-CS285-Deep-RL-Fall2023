...
* I do 3.2 first, I do grid search on `Ant` and select a set of hyperparameters, apply to both BC and DA, and run on all four tasks.
* Although the homework only asks us to choose two of four, I just try all of them.
* Use hyperparameters:
  ```python
