...
class MemoryEfficientReplayBuffer:
    ...
    def __init__(self, frame_history_len: int, capacity=1000000):
        ...
        ## set indices size `capacity`(1M default), 
        ## then the largest frame buffer size needed is `capacity + frame_history_len`(1M+4),
        ## this is enough to support both obs and next_obs.
        self.max_framebuffer_size = capacity + frame_history_len
    ...
    def _insert_frame(self, frame: np.ndarray) -> int:
        ...
        self.framebuffer[self.framebuffer_idx % self.max_framebuffer_size] = frame  # correction
